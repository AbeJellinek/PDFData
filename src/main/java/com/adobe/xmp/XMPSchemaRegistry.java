...
public interface XMPSchemaRegistry {
     ...
     * @param suggestedPrefix The suggested prefix to be used if the URI is not yet
     ...
     *
     * @param namespaceURI The URI for the namespace. Must not be null or the empty
     *                     string.
     ...
     *
     * @param namespacePrefix The prefix for the namespace. Must not be null or the empty
     *                        string.
     ...
     *
     * @param aliasNS   The namespace URI of the alias. Must not be <code>null</code> or the empty
     *                  string.
     * @param aliasProp The name of the alias. May be an arbitrary path expression
