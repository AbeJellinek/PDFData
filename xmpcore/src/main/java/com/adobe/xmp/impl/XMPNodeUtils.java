...
public class XMPNodeUtils implements XMPConst {
     ...
     * @param childName   the node name to find
     * @param createNodes flag, if new nodes shall be created.
     ...
     * </ol>
     *
     * @param arrayNode    the alt text array node
     * @param genericLang  the generic language
     * @param specificLang the specific language
