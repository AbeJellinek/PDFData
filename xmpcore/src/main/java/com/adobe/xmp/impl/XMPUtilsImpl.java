...
public class XMPUtilsImpl implements XMPConst {
     ...
     * @param schemaNS    The schema namespace URI for the array. Must not be null or
     *                    the empty string.
     * @param arrayName   The name of the array. May be a general path expression, must
     *                    not be null or the empty string. Each item in the array must
     *                    be a simple string value.
     * @param separator   The string to be used to separate the items in the catenated
     *                    string. Defaults to &quot;; &quot;, ASCII semicolon and space
     *                    (U+003B, U+0020).
     * @param quotes      The characters to be used as quotes around array items that
    ...
    /**
     * @param xmp             The XMP object containing the properties to be removed.
     * @param schemaNS        Optional schema namespace URI for the properties to be
     *                        removed.
     ...
     * @param includeAliases  Option flag to control the deletion: Include aliases in the
     ...
     * @param doAllProperties flag if all properties or only externals shall be removed.
     ...
     *
     * @param quotes    opened and closing quote in a string
     * @param openQuote the open quote
    ...
    /**
     * @param openQuote the open quote char
...
//			return 0x005D;
     ...
     * @param openQuote   the open quote character
     * @param closeQuote  the closing quote character
     * @param allowCommas flag if commas are allowed
